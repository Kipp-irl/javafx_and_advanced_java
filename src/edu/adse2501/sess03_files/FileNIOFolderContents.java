    ...
    public static void main(String[] args) {
        ...
        try (Scanner sc = new Scanner(System.in)) {
            ...
            if (Files.isDirectory(path2Directory)) {
                ...
                // We use try-with-resources here to ensure the stream closes properly
                ...
                // Manually throw an exception if the folder isn't found
                throw new IOException();
            }

        } catch (IOException ioe) {
            // This block handles errors from the file system OR the manual throw above
