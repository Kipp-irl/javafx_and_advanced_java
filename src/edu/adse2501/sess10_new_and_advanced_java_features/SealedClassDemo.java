...
sealed abstract class Payment permits CreditCardPayment, PayPalPayment
{
    ...
    /**
     * Abstract method to process the payment. This must be implemented by subclasses.
     */
 ...
 * * - This class cannot be further extended, as it is both final and permitted by Payment
 * @author Victor
 */
